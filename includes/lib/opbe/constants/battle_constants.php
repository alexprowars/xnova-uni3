...
define('SHIELD_CELLS', 200); //how many cells a ship's shield should contain. Carefull to edit: more cells = better accuracy but less bounces in some cases.
...
define('SHIELDS_TECH_INCREMENT_FACTOR', 0.05); //how much a level increase the shield, in percentage from 0 to 1.
define('ARMOUR_TECH_INCREMENT_FACTOR', 0.05); //how much a level increase the armour, in percentage from 0 to 1.
define('WEAPONS_TECH_INCREMENT_FACTOR', 0.05); //how much a level increase the weapon, in percentage from 0 to 1
