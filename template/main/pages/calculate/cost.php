...
<script type="text/javascript" src="/scripts/calculate/costs.js"></script>
...
<style>
	...
	#tabtag-0, #tabtag-1, #tabtag-2, #tabtag-0-2, #tabtag-0-3, #tabtag-0-4, #tabtag-0-5, #tabtag-0-6, #tabtag-1-2, #tabtag-1-3, #tabtag-1-4 { padding: .1em 1em; }
	...
	<div id="general-settings">
		<table class="table" cellpadding="2" cellspacing="0" border="0" align="center">
			...
			<tr>
				...
				<td></td>
				<td>
					<input type="hidden" id="universe-speed" name="universe-speed" value="<?=system::getGameSpeed() ?>">
				</td>
			</tr>
		</table>
	</div>
