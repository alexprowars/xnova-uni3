...
<script type="text/javascript" src="/scripts/jquery.ui.spinbtn.js"></script>
<script type="text/javascript" src="/scripts/jquery.inputmask.js"></script>
<script type="text/javascript" src="/scripts/calculate/utils.js"></script>
<script type="text/javascript" src="/scripts/calculate/common.js"></script>
<script type="text/javascript" src="/scripts/calculate/flight.js"></script>
...
<div id="flight">
	<div class="ui-widget-content ui-corner-all">
		...
		<div>
				...
				<div id="general-settings">
					<table cellpadding="2" cellspacing="0" border="0" align="center">
						<tr>
							...
							<td></td>
							<td>
								<input type="hidden" id="universe-speed" name="universe-speed" value="<?=(core::getConfig('fleet_speed')/ 2500)?>">
							</td>
						</tr>
					</table>
			...
			<div id="tabs">
				<ul>
					<li><a id="tabtag1" href="#flight-times-panel"  tabindex="21" >Время в пути</a></li>
					<!--<li><a id="tabtag2" href="#save-points-panel" tabindex="22" >Точки сейва</a></li>-->
				</ul>
				...
				<!--<div id="save-points-panel" class="ui-panel">
					<div style="float: right;">
						<button id="calculate-savepoints" tabindex="30" >Найти</button>
					</div>
							...
							<tr>
								...
								<td>
									<div style="margin: 0px;">
										<input type="text" id="save-start-datetime" class="ui-state-default ui-corner-all ui-input startdate-input"  title="дд.мм.гггг чч:мм:сс" tabindex="26" />
									</div>
								</td>
								<td>
									<button id="set-save-departure-now" tabindex="27"  title="Установить время отправления - сейчас">(сейчас)</button>
								</td>
								<td width=10px;>
									&nbsp;
								</td>
								...
								<td>
									<div style="margin: 0px;">
										<input type="text" id="save-return-datetime" class="ui-state-default ui-corner-all ui-input startdate-input"  title="дд.мм.гггг чч:мм:сс" tabindex="28" />
									</div>
								</td>
								<td width=10px;>
									&nbsp;
								...
								<td>
									<span>Макс. погрешность</span>
								</td>
								<td>
									<input type="text" id="save-tolerance-time" class="ui-state-default ui-corner-all ui-input tolerance-time-input"  title="чч:мм" tabindex="29" />
								</td>
							</tr>
						</table>
					</div>
