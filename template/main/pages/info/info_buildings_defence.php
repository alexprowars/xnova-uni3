	...
	<tr>
		...
		<th><?=strings::pretty_number($parse['hull_pt']) ?></th>
	</tr>
	<tr>
...
<? endif; ?>
	...
	<? if (isset($parse['gun']) && $parse['gun']): ?>
	<tr>
		<th>Тип оружия</th>
		<th><?=$parse['gun'] ?></th>
	</tr>
		<? endif; ?>
	<? if (isset($parse['armour']) && $parse['armour']): ?>
	<tr>
		<th>Тип брони</th>
		<th><?=$parse['armour'] ?></th>
	</tr>
...
<? if (isset($parse['speedBattle']) && count($parse['speedBattle']) > 0): ?>
